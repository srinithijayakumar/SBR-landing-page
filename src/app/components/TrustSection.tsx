          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative z-10 max-w-md mx-auto">
              <div className="relative w-64 sm:w-80 h-80 sm:h-96 mx-auto">
                <div className="absolute inset-0 bg-gradient-to-br from-[#1C6EF2] to-blue-600 rounded-[3rem] shadow-2xl shadow-blue-500/30 flex items-center justify-center transform hover:scale-105 transition-transform duration-500">
                ...
                <motion.div
                  ...
                  className="absolute -top-4 -right-4 w-20 h-20 bg-white rounded-2xl flex items-center justify-center border border-slate-200"
                >
                  <UserCheck className="w-10 h-10 text-blue-500" strokeWidth={2} />
                </motion.div>
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#1C6EF2]/30 via-blue-500/30 to-blue-600/30 blur-3xl -z-10" />
            </div>
          </div>

          <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
            <div>
              <div className="inline-block px-3 sm:px-4 py-2 rounded-full bg-blue-50 text-blue-600 font-semibold text-xs sm:text-sm border border-green-100 mb-4 sm:mb-6">
                Your Safety First
              </div>
            ...
            {/* Trust Badge */}
            <div className="pt-6">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-50 to-blue-100 px-6 py-4 rounded-2xl border border-blue-200">
                <div className="w-10 h-10 rounded-full bg-[#1C6EF2] flex items-center justify-center">
