...
export function HeroSection() {
  return (
    <section id="home" className="relative pt-4 sm:pt-8 pb-8 sm:pb-24 overflow-hidden bg-gradient-to-b from-white via-slate-50/50 to-white mobile-container no-scroll-mobile scroll-mt-24 mx-4 sm:mx-20">
